...
// By: ant-design
// See: https://v0.app/icon/ant-design/instagram-filled
// Example: <IconAntDesignInstagramFilled width="24px" height="24px" style={{color: "#000000"}} />

export const IconAntDesignInstagramFilled = ({
  height = "1em",
  fill = "currentColor",
  focusable = "false",
  ...props
